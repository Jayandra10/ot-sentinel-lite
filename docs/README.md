...
This folder documents the OT Sentinel Lite project from quick orientation to deep implementation details.
...
| `pi-integration-plan.md` | Transition plan from synthetic to hardware evidence |

## Suggested usage by audience

- Developers: `architecture.md`, then `repository-guide.md`.
- Instructors or reviewers: `README.md`, then `demo-runbook.md`.
- Lab operators: `step-by-step.md`, then `pi-integration-plan.md`.
